...
async function saveTrekChanges(trekId) {
  ...
  // funktsioon, kus tehakse treki uuendamise päring
  // kontrollime, ega ükski väli tühi ei ole

  // teeme PUT päringu, kus saadame ID ja sellele ID'le vastavad treki väärtused
  // await fetch(`${API_URL}/api/treks/${trekId}`, { method: 'PUT', ...})
}
